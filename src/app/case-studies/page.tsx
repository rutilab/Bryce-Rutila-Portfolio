  ...
  return (
    <main className="min-h-screen px-4 pt-28 pb-12">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Glass modal wrapping header + cards */}
        <div
          style={{
            ...
            {caseStudies.map((study) => (
              ...
              >
                <div
                  ...
                  className="group-hover:scale-[1.02] group-hover:bg-white/10"
                >
                  ...
                  <div className="p-5">
                    <div className="flex justify-between items-start gap-3">
                      <div>
                        ...
                        <p className="text-white/70 text-[13px] leading-[160%] mb-2">{study.description}</p>
                        <p className="text-white/50 text-[12px]">{study.role}</p>
                      </div>
                      <svg
                        width="18"
                        height="18"
                        ...
                        className="text-white/40 group-hover:text-white/80 group-hover:translate-x-1 transition-all shrink-0 mt-0.5"
                      >
                        <path d="M5 12h14" />
